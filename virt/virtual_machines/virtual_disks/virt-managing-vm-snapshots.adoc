...
[id="restoring-vms-from-snapshots"]
== Restoring virtual machines from snapshots

You can restore virtual machines (VM) from snapshots by using the {product-title} web console or the command line.
...
[id="deleting-snapshots_{context}"]
== Deleting snapshots
